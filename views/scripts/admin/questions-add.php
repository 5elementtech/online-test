...
<div id="questions" class="questions" style="width: 100%; height: 675px;">
	<div id="question_dtl" class="question_dtl" style="">
	<table>
	<tr>
		<td width="120" class="mcstyle"> Question Type : </td>
		<td width="130" class="mcstyle"> <input type="radio" id="0" id="question_type" name="question_type" checked value="0">Multiple Choice</td>
		<td width="80" class="mcstyle"> <input type="radio" id="1" id="question_type" name="question_type" value="1">Essay</td>
	</tr>
	</table>
		...
		<tr>
			<td><textarea id="question" name="question" rows="6" cols="38"> </textarea> </td>
		</tr>
		<tr>
			<td> 
